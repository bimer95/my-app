...
const userReducer = (state = initialState, action:any):InitialState => { /* Reducer функция с помощью которой идет 
                                                         модификация state */
    switch (action.type) {
        case FOLLOW:
            return {
...
export const requestUsers = (page:number, pageSize:number) => { //санки
